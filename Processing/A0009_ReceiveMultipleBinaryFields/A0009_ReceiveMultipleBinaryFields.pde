/*
 * ReceiveMultipleBinaryFields
 *
 * Set portIndex to the port connected to the Arduino.
 * Use with the ArduinoCookbook sketch: SendBinaryFields
 */
 
import processing.serial.*;
 
Serial myPort;  // create object from Serial Class
short portIndex = 4;  // Select the com port, 0 is the first port
