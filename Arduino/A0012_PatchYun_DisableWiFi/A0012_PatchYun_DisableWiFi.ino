/*
*  A0012
 * Permanently disables Arduino Yun WiFi using Linux Shell Commands.
 * WiFi is disabled after power cycle without the need to rerun this patch.
 *
 * Requires the bridge library, which can be obtained directly within the
 * Arduino IDE in Library Manager and then searching for "bridge".
 *
 * Source:
