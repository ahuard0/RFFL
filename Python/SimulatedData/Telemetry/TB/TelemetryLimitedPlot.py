...
# Create a scatter plot of the limited data with color-coded clusters
...
for cluster_id, color in zip(unique_clusters, cluster_colors):
    ...
    plt.scatter(cluster_points['signal_indices'], cluster_points['signal_data'], color=color, alpha=0.7, label=f'Cluster {cluster_id}')

# Customize the chart
plt.xlabel('Signal Indices')
plt.ylabel('Magnitude')
plt.title('Signal Data above Threshold')
